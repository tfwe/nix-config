{
  programs.plasma = {
    ...
    configFile = {
      ...
      "dolphinrc"."ExtractDialog"."2560x1440 screen: Height" = 709;
      "dolphinrc"."ExtractDialog"."2560x1440 screen: Width" = 1642;
      ...
      "dolphinrc"."ExtractDialog"."DirHistory\x5b$e\x5d" = "$HOME/Carleton/COMP4102/Assignments/,/run/media/carlo/SWITCH SD/";
      ...
      "kactivitymanagerdrc"."activities"."61d89949-fb69-47dd-aeda-eda14be9a40a" = "Default";
      ...
      "kwinrc"."Wayland"."InputMethod\x5b$e\x5d" = "$HOME/.local/share/applications/org.fcitx.Fcitx5.desktop";
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.2.Applets.5.Configuration.General"."launchers" = "applications:systemsettings.desktop,preferred://filemanager,preferred://browser,file:///run/current-system/sw/share/applications/org.kde.konsole.desktop,file:///home/carlo/.nix-profile/share/applications/org.keepassxc.KeePassXC.desktop,applications:spotify.desktop";
